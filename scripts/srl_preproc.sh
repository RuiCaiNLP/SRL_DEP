...
python -mnnet.run.srl.training_sample_2 --data data/conll2009/train_conll2009.json.dep --frames data/nombank_descriptions-1.0+prop3.1.json > conll2009.train.dep_l
...
python -mnnet.run.srl.training_sample_2 --data data/conll2009/dev_conll2009.json.dep --frames data/nombank_descriptions-1.0+prop3.1.json > conll2009.dev.dep_l
