...
--train conll2009_batch_2.dev \
--test conll2009_batch_2.dev \
--data_partition dev \
--batch 30 \
...
--params-path Model1_4L_F_R_P_embedsSDP_withEgate_onTrainSetJK_depInHigway_relu.pkl \
--test-mode True \
...
#--params-path model_bilstm_3L_seed1_30_256_fullSDP_6.pkl \