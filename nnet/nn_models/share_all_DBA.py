...
class BiLSTMTagger(nn.Module):
    ...
    def __init__(self, hps, *_):
        ...
        self.bias_roles_embeddings = nn.Embedding(self.tagset_size, 1)
        ...
        self.W_R = nn.Parameter(torch.rand(self.argument_size + 0, self.tagset_size * (self.argument_size + 0)))
    ...
    def forward(self, sentence, p_sentence,  pos_tags, lengths, target_idx_in, region_marks,
        ...
        lin = lin.view(self.batch_size, -1, self.argument_size)
        predicate_embeds = predicate_embeds.view(self.batch_size, self.argument_size, 1)
